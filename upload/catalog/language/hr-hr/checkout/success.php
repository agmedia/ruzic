...
$_['text_customer']        = '<p>Vaša narudžba je uspješno zaprimljena i obrađena i bit će dostavljena na odabrani datum!</p><p>Možete pogledati pregled Vaših narudžbi na stranici <a href="%s">moj korisnički račun</a> ili kliknuvši na <a href="%s">povijest narudžbi</a>.</p><p style="display:none">Ako Vaša narudžba sadrži artikle za download, možete otići na <a href="%s">download</a> stranicu da ih pogledate i preuzmete.</p><p>Molimo Vas da ukoliko imate nekih pitanja ista uputite <a href="%s">vlasniku web trgovine</a>.</p><p>Zahvaljujemo se što ste kupovali online kod nas!</p>';



$_['text_guest']           = '<p>Vaša narudžba je uspješno zaprimljena i obrađena i bit će dostavljena na odabrani datum!</p><p>Molimo Vas da ukoliko imate nekih pitanja ista uputite <a href="%s">vlasniku web trgovine</a>.</p><p>Zahvaljujemo se što ste kupovali online kod nas!</p>';


$_['text_guest_hrv']           = '<p>Vaša narudžba je uspješno zaprimljena i obrađena!</p><p>Molimo Vas da ukoliko imate nekih pitanja ista uputite <a href="%s">vlasniku web trgovine</a>.</p><p>Zahvaljujemo se što ste kupovali online kod nas!</p>';
