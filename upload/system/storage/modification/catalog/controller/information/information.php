...
class ControllerInformationInformation extends Controller {
	...
	public function index() {
		...
		if ($information_info) {
			...
			$data['heading_title'] = ($information_info['custom_h1'] <> '')?$information_info['custom_h1']:$information_info['title'];
...
$data['description'] = ($information_info['custom_h2'] != '')?'<h2>'.$information_info['custom_h2'].'</h2>'.$data['description']:$data['description'];
