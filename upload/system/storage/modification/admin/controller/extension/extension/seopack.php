...
public function clearalts() {
		...
		$query = $this->db->query("update " . DB_PREFIX . "product_description_seo set custom_alt = '';");
...
public function clearh1s() {
		...
		$query = $this->db->query("update " . DB_PREFIX . "product_description_seo set custom_h1 = '';");
...
public function clearimgtitles() {
		...
		$query = $this->db->query("update " . DB_PREFIX . "product_description_seo set custom_imgtitle = '';");
		
		$this->session->data['success'] = "Custom imgtitles were deleted.";
